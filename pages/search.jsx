...
function Search({ router, repos }) {
    ...
    return (
        <div className="root">
            <Row gutter={20}>
                <Col span={6}>
                    <List style={{marginBottom: 20}} bordered header={<span className="list-header">语言</span>} 
                        dataSource={LANGUAGES} renderItem={item => {
                    ...
                    />
                    <List bordered header={<span className="list-header">排序</span>}
                        dataSource={SORT_TYPES} renderItem={item => {
                            let selected = false
